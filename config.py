...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6022510818:AAGutnwn7eW5tF3yXRF67QG--6ohEAbI1RI")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001860678095"))

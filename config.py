...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6074522431:AAEsif1gAvlgfM0zYz9zKdJeD7flp8mJX2Y")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001912633959"))
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://qjhpzlli:rzj7UP6Qe_uhHrNxtwqemrHZuh7euWf-@trumpet.db.elephantsql.com/qjhpzlli")
...
ADMINS.extend((5254177746, 6198858059, 5048278767, 6299128233))
